...
export class Cognito extends Construct {
  ...
  private createUserPoolGroups = (
    ...
    const patientGroupRole = this.createPatientGroupRole(
      userPool,
      identityPool,
    );
  ...
  private createPatientGroupRole = (
    ...
    return new iam.FederatedPrincipal(
      'cognito-identity.amazonaws.com',
      {
        ...
        'ForAnyValue:StringLike': {
          'cognito-identity.amazonaws.com:amr': isAuthorized
            ? 'authenticated'
            : 'unauthenticated',
        },
      },
  ...
  private createSharedInlinePolicies = (): Record<
    string,
    iam.PolicyDocument
  > => {
    return {
